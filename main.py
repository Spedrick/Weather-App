...
new = ImageTk.PhotoImage(Image.open(dir_path + 'logo.png')) 
...
if int((dt.strftime('%I'))) >= 8 & int((dt.strftime('%I'))) <= 5: 
	img = ImageTk.PhotoImage(Image.open(dir_path + 'moon.png')) 
	panel = Label(root, image=img) 
	panel.place(x=210, y=200) 
else: 
	img = ImageTk.PhotoImage(Image.open(dir_path + 'sun.png')) 
	panel = Label(root, image=img) 
	panel.place(x=210, y=200) 
